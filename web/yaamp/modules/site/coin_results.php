...
echo ", Cleared ".CHtml::link($reserved1, "/site/payments?id=".$coin->id)." $symbol <br/><br/>";
...
$maxrows = (int) arraySafeVal($_GET,'rows', 1000);
$maxrows = max($maxrows,  1000);
$maxrows = min($maxrows, 32000);
